              ...
              <div class="row">
                <div class="col-md-7 col-lg-6">
                  <div class="detail-box">
                    ...
                    <div class="btn-box">
                      <router-link to="/menu" class="btn1">Order Now</router-link>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="container">
            <div class="heading_container heading_center">
              ...
              <div class="filters-content">
                <div class="row grid">
                  <div class="col-sm-6 col-lg-4" v-for="item in filteredData" :key="item.id">
                    <div class="box">
                      <div>
                        <div class="img-box">
  ...
  mounted() {
    if (this.data.length === 0) {
      this.$store.dispatch('fetchData')
        .then(() => {
          this.data = this.$store.getters.nonDeletedProducts
        })
        .catch(error => {
          console.error(error);
        });
